...
class Articulos(models.Model):
    ...
    item_suspendido = models.BooleanField(verbose_name= 'Item suspendido', null=True)
    motivo_suspension = models.TextField (verbose_name='Motivo suspension', blank=True,default=False)
