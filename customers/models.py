...
class Customer(models.Model):
    name = models.CharField(max_length=255, null=False, blank=False, editable=True, verbose_name='Nombre/s')
    surname = models.CharField(max_length=255, null=False, blank=False, editable=True, verbose_name='Apellido/s')
